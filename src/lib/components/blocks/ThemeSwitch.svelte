...
<label class="group relative block text-[1.2vh] select-none cursor-pointer transition-all duration-300 ease-in-out" aria-label="Toggle Theme">
	<input
		type="checkbox"
		class="hidden"
	...
	<div class="relative w-[5.625em] h-[2.5em] rounded-[6.25em] overflow-hidden transition-all duration-500 ease-[cubic-bezier(0,-0.02,0.4,1.25)] {isDarkMode ? 'bg-[#1D1F2CBF]' : 'bg-[#3D7EAEBF]'}">
		...
		<!-- Kreis -->
		<div class="absolute flex w-[3.375em] h-[3.375em] top-[-0.4375em] rounded-[6.25em] bg-white/10 shadow-[inset_0_0_0_3.375em_rgba(255,255,255,0.1),0_0_0_0.625em_rgba(255,255,255,0.1)] transition-all duration-300 ease-[cubic-bezier(0,-0.02,0.35,1.17)] {isDarkMode ? 'left-[calc(100%-0.3375em-2.575em)]' : 'left-[-0.4375em]'}">
			<div class="relative m-auto w-[2.125em] h-[2.125em] rounded-full overflow-hidden transition-all duration-500 ease-[cubic-bezier(0,-0.02,0.4,1.25)] {isDarkMode ? 'bg-[#C4C9D1]' : 'bg-[#ECCA2F]'}">
				<!-- Mondflecken -->
				{#if isDarkMode}
					<div class="absolute top-[0.75em] left-[0.312em] w-[0.75em] h-[0.75em] rounded-full bg-[#959DB1]"></div>
					<div class="absolute top-[0.937em] left-[1.375em] w-[0.375em] h-[0.375em] rounded-full bg-[#959DB1]"></div>
					<div class="absolute top-[0.312em] left-[0.812em] w-[0.25em] h-[0.25em] rounded-full bg-[#959DB1]"></div>
				{/if}
			</div>
		</div>
	</div>
